...
import forgot_pwd from '@/assets/images/forgot_pwd.png'
...
<template>
    <div class="body">
        ...
        <img :src="forgot_pwd" alt="recommender system" class="image"/>
        ...
        <div v-if="! resetPage" class="container">
            <div class="box">
                ...
                <div class="sign-in" @click="router.push('/login')">Back to Sign in</div>
            </div>
        </div>
        ...
        <div v-if="resetPage" class="container">
            <div class="box">
                ...
                <form class="form" @submit.prevent="reset_password" autocomplete="off">
                    ...
                    <div class="content-form">
                        <input type="password" v-model="confirm_pwd" id="password" placeholder="Confirm Password" autocomplete="current-password" required />
